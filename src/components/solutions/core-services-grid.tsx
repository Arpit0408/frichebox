          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            {servicesData.map((service) => (
              <motion.div
                key={service.id}
                variants={fadeIn}
                className="group bg-white overflow-hidden shadow-lg hover:shadow-2xl border border-neutral-100 flex flex-col transition-all duration-300 transform hover:-translate-y-1.5"
              >
                {/* Top Image */}
